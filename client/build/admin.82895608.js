...
},{"./cjs/react-dom.development.js":"../../../node_modules/react-dom/cjs/react-dom.development.js"}],"../js/admin.jsx":[function(require,module,exports) {
"use strict";
...
function (_React$Component) {
  ...
  function App(props) {
    ...
    _this.questions = _react.default.createRef();
  ...
  _createClass(App, [{
    ...
    value: function componentDidMount() {
      ...
      this.start.current.addEventListener('click', function (e) {
        e.preventDefault();
        var questions = _this2.questions.current;
        var selected = questions.options[questions.selectedIndex].value;
        fetch("/start/".concat(selected)).then(function (res) {
          return res.json();
      ...
      var endRound = function endRound(id) {
        return function (e) {
          if (_this2.state.options[id]) {
            e.preventDefault();
            fetch("/end/".concat(id)).then(function (res) {
              return res.text();
            }).then(function (res) {
              return _this2.setState({
                options: []
    ...
    value: function render() {
      ...
      var selectOptions = questions.map(function (question, ind) {
        return _react.default.createElement("option", {
          key: ind,
          value: ind
        }, "".concat(question[0], " or ").concat(question[1]));
      });
      return _react.default.createElement("div", {
        className: "admin"
      }, _react.default.createElement("h1", null, "Would They Rather Admin"), _react.default.createElement("select", {
        ref: this.questions
      }, selectOptions), _react.default.createElement("button", {
        ref: this.start
      }, "Start Question"), _react.default.createElement("div", {
        className: "options"
...
},{}]},{},["../../../../../../../AppData/Roaming/npm/node_modules/parcel/src/builtins/hmr-runtime.js","../js/admin.jsx"], null)
//# sourceMappingURL=/admin.82895608.map